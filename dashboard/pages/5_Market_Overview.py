...
if section == "Markets":
    ...
    st.plotly_chart(fig_sectors, width="stretch", config=PLOTLY_CONFIG, theme=None)
    ...
    if not perf_df.empty:
        ...
        st.plotly_chart(fig_perf, width="stretch", config=PLOTLY_CONFIG_INTERACTIVE, theme=None)
    ...
    with g1:
        ...
        if not ata.empty:
            ...
            st.plotly_chart(_light_chart(fig, 200, "ATA Trucking Index"), width="stretch", config=PLOTLY_CONFIG, theme=None)
    ...
    with g2:
        ...
        if not ism.empty:
            ...
            st.plotly_chart(_light_chart(fig, 200, "ISM Manufacturing PMI"), width="stretch", config=PLOTLY_CONFIG, theme=None)
    ...
    with g3:
        ...
        if not dgo.empty:
            ...
            st.plotly_chart(_light_chart(fig, 200, "Durable Goods Orders (MoM %)"), width="stretch", config=PLOTLY_CONFIG, theme=None)
    ...
    with l1:
        ...
        if not ic.empty:
            ...
            st.plotly_chart(_light_chart(fig, 200, "Initial Jobless Claims (4-Week Avg)"), width="stretch", config=PLOTLY_CONFIG, theme=None)
    ...
    with l2:
        ...
        if not jolts_ld.empty:
            ...
            st.plotly_chart(_light_chart(fig, 200, "JOLTS — Layoffs & Discharges Rate"), width="stretch", config=PLOTLY_CONFIG, theme=None)
    ...
    with l3:
        ...
        if not rail.empty:
            ...
            st.plotly_chart(_light_chart(fig, 200, "Rail Intermodal Traffic"), width="stretch", config=PLOTLY_CONFIG, theme=None)
    ...
    with c1:
        ...
        if not umcs.empty:
            ...
            st.plotly_chart(_light_chart(fig, 200, "U. Michigan Consumer Sentiment"), width="stretch", config=PLOTLY_CONFIG, theme=None)
    ...
    with c2:
        ...
        if not rsxfs.empty:
            ...
            st.plotly_chart(_light_chart(fig, 200, "Retail Sales ex-Autos (MoM %)"), width="stretch", config=PLOTLY_CONFIG, theme=None)
    ...
    with c3:
        ...
        if not cpi_food.empty:
            ...
            st.plotly_chart(_light_chart(fig, 200, "CPI — Food at Home (Index Level)"), width="stretch", config=PLOTLY_CONFIG, theme=None)
    ...
    if not yc.empty:
        ...
        st.plotly_chart(_light_chart(fig_yc, 240, "10Y–2Y Treasury Yield Curve Spread"), width="stretch", config=PLOTLY_CONFIG, theme=None)
